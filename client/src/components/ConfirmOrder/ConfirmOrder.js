  ...
  if (shipInfo.country === "VN") {
    ...
    for (let i = 0; i < products.length; i++) {
      ...
      if (products[i].localShipmentPolicy === "custom") {
        shippingCharge =
          shippingCharge +
          products[i].quantity * products[i].customLocalShipmentPolicy;
      ...
      if (products[i].localShipmentPolicy === "standard") {
        if (products[i].weight && products[i].weight > 5) {
          ...
          shippingCharge =
            ...
            products[i].weight *
              products[i].quantity *
              process.env.REACT_APP_LOCAL_CHARGE;
          unitShippingCharge[i] =
            products[i].weight *
            products[i].quantity *
            process.env.REACT_APP_LOCAL_CHARGE;
    ...
    for (let i = 0; i < products.length; i++) {
      ...
      if (products[i].internationalShipmentPolicy === "custom") {
        shippingCharge =
          shippingCharge +
          products[i].quantity * products[i].customInternationalShipmentPolicy;
        unitShippingCharge[i] =
          products[i].quantity * products[i].customInternationalShipmentPolicy;
      }
      if (products[i].internationalShipmentPolicy === "standard") {
        if (products[i].weight && products[i].weight > 5) {
          ...
          shippingCharge =
            ...
            products[i].weight *
              products[i].quantity *
              process.env.REACT_APP_INTER_CHARGE;
          unitShippingCharge[i] =
            products[i].weight *
            products[i].quantity *
            process.env.REACT_APP_INTER_CHARGE;
